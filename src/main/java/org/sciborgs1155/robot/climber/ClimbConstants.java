...
public class ClimbConstants {
  ...
  // Gains
  public static final double kP = 25.583; // 25.589? P,//0.09266 V, 0.00074699 V
  public static final double kI = 0;
  public static final double kD = 0.38591; // 0.306? P, 0 V
  ...
  public static final double MAX_VELO = 3;
  public static final double MAX_ACCEL = 0.9;
