...
public class SimModule implements TankModuleIO {
  ...
  private final DCMotorSim frontMotor = new DCMotorSim(
      ...
      DCMotor.getNeoVortex(1), SimConstants.GEARING);
  ...
  public Command setVoltage(Measure<Voltage> voltage) {
    ...
    }, this).andThen(Commands.idle(this));
  }

  @Override
  public Measure<Distance> getPosition() {
    return Meters
        .of((frontMotor.getAngularPositionRotations() + rearMotor.getAngularPositionRotations())
            * DriveConstants.WHEEL_RADIUS.in(Meters) * Math.PI);
  }

  @Override
  public Measure<Velocity<Distance>> getVelocity() {
    return MetersPerSecond
        .of((frontMotor.getAngularVelocityRPM() + rearMotor.getAngularVelocityRPM())
            * DriveConstants.WHEEL_RADIUS.in(Meters) * Math.PI);
  }
